...
import mainLogo from "../../assets/bookmytheatre_white.png";
  ...
  return (
    <footer className="bg-[#2b2b2b] text-gray-400 text-sm">
      ...
      <div className="flex flex-col items-center py-6">
        {/* Logo */}
        <img src={mainLogo} alt="BookMyTheatre Logo" className="w-28 mb-4" />
        ...
        <p className="text-center text-xs px-4 max-w-4xl">
          Copyright 2026 © BookMyTheatre Pvt Ltd. Ltd. All Rights Reserved.
          <br />
        </p>
        <small>
